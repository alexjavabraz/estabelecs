...
@NamedQueries({
	@NamedQuery(name = Cidade.BUSCAR_POR_NOME_ESTADO, query="from br.com.bjbraz.app.estabelecimentos.entity.Cidade c "
		+ " where uf = :nomeEstado order by cidade"),
		
	        @NamedQuery(name = Cidade.BUSCAR_POR_ID_ESTADO, query="from br.com.bjbraz.app.estabelecimentos.entity.Cidade c "
